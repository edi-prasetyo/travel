    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Apakah Anda Yakin Ingin Menghapus Menu <b><?php echo $data->link_name ?></b>?</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-close"></i> Batal</button>
                <a href="<?php echo base_url('admin/link/delete/' . $data->id) ?>" class="btn btn-danger ml-3 text-white"><i class="fa fa-close"></i> Ya, Hapus Data</a>
            </div>
        </div>
    </div>
</div>