...
<div class="card mb-4">
    ...
    <div class="card-body">
        ...
        <?php
        echo form_open_multipart('admin/tour/create',  array('class' => 'needs-validation', 'novalidate' => 'novalidate'));
        ?>
        <div class="form-group row mb-3">
            <label class="col-lg-3 col-form-label">Judul <span class="text-danger">*</span>
            </label>
            <div class="col-lg-9">
                <input type="text" class="form-control" name="tour_title" placeholder="Judul" value="<?php echo set_value('tour_title'); ?>" required>
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-lg-9">
                <input type="text" class="form-control" name="tour_price" placeholder="Harga" value="<?php echo set_value('tour_price'); ?>">
            </div>
        </div>
        <div class="form-group row mb-3">
            ...
            <div class="col-lg-9">
                <input type="text" class="form-control" name="tour_duration" placeholder="Durasi" value="<?php echo set_value('tour_duration'); ?>">
            </div>
        </div>
        <div class="form-group row mb-3">
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-lg-9">
                <textarea id="summernote3" class="form-control" name="tour_facility" placeholder="Facility" value="<?php echo set_value('tour_facility'); ?>"></textarea>
            </div>
        </div>
        <div class="form-group row mb-3">
            ...
            <div class="col-lg-9">
                <textarea class="form-control" id="summernote" name="tour_description" placeholder="Deskripsi" required><?php echo set_value('tour_description'); ?></textarea>
        ...
        <?php if ($setting->language == 1) : ?>
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-lg-9">
                    <input type="text" class="form-control" name="tour_title_en" placeholder="Tour Title" value="<?php echo set_value('tour_title_en'); ?>">
                </div>
            </div>
            <div class="form-group row mb-3">
                ...
                <div class="col-lg-9">
                    <textarea id="summernote4" class="form-control" name="tour_facility_en" placeholder="Facility" value="<?php echo set_value('tour_facility_en'); ?>"></textarea>
                </div>
            </div>
            <div class="form-group row mb-3">
                ...
                <div class="col-lg-9">
                    ...
                    <textarea class="form-control" id="summernote2" name="tour_description_en" placeholder="Deskripsi" required><?php echo set_value('tour_description_en'); ?></textarea>
                    <div class="invalid-feedback">Silahkan Isi Deskripsi Berita</div>
                </div>
            </div>
        <?php else : ?>
